...
var DiscoverMoviesContainer = React.createClass({ displayName: "DiscoverMoviesContainer",
  ...
  render: function render() {
    ...
    return React.createElement("div", { id: "moviesContainer", className: "col-lg-12 col-md-12 col-xs-12 moviesContainer" }, React.createElement("div", { id: "discoveryChooserContainer", className: "col-lg-12 col-md-12 col-xs-12" }, React.createElement("div", { id: "discoveryChooserLabel", className: "col-lg-4 col-md-4 col-xs-12" }, React.createElement("h3", { id: "discoverLabel" })), React.createElement("div", { id: "discoveryChooserButtons", className: "col-lg-9 col-md-9 col-xs-12" }, React.createElement("div", null, React.createElement("button", { id: "OneMonthButton", className: "btn btn-success", onClick: this.handleClick1 }, "MOVIES - LAST MONTH")), React.createElement("div", null, React.createElement("button", { id: "ThreeMonthButton", className: "btn btn-success", onClick: this.handleClick3 }, "MOVIES - LAST 3 MONTHS")), React.createElement("div", null, React.createElement("button", { id: "ThreeMonthButton", className: "btn btn-warning", onClick: this.handleClickTvTop }, "TV - TOP RATED")), React.createElement("div", null, React.createElement("button", { id: "ThreeMonthButton", className: "btn btn-warning", onClick: this.handleClickTvAir }, "TV - AIRING TODAY")))), React.createElement("div", { id: "innerDiscoverContainer" }, React.createElement(ReactCSSTransitionGroup, { transitionName: "example" }, moviesArray)));
  }
});
