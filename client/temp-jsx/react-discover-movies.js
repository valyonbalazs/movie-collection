          ...
          React.createElement("div", {id: "discoveryChooserContainer", className: "col-lg-12 col-md-12 col-xs-12"}, 
            ...
            React.createElement("div", {id: "discoveryChooserButtons", className: "col-lg-9 col-md-9 col-xs-12"}, 
              React.createElement("div", null, 
                  ...
                  React.createElement("i", {className: "fontawesomeBtn fa fa-film", onClick: this.handleClick1}), "1 Month"
            ), 
              React.createElement("div", null, 
                  ...
                  React.createElement("i", {className: "fontawesomeBtn fa fa-film", onClick: this.handleClick3}), "3 Month"
            ), 
              React.createElement("div", null, 
                  ...
                  React.createElement("i", {className: "fontawesomeBtn fa fa-tv", onClick: this.handleClickTvTop}), "Top rated"
            ), 
              React.createElement("div", null, 
                  ...
                  React.createElement("i", {className: "fontawesomeBtn fa fa-television", onClick: this.handleClickTvAir}), "Airing"
            )
            )
          ), 
