    ...
    if (wasTvBtnClicked == false) {
      return (
        React.createElement("div", {id: "movieDetailsContainer", className: "col-lg-12 col-md-12 col-xs-12 movie"}, 
          React.createElement("div", {id: "movieDetailsPoster", className: "col-lg-5 col-md-5 col-xs-12"}, 
            React.createElement("img", {src: this.state.data.posterPath})
          ), 
          React.createElement("div", {id: "movieDetailsContent", className: "col-lg-7 col-md-7 col-xs-12"}, 
            React.createElement("div", {id: "movieDetailsTitle", className: "col-lg-12 col-md-12 col-xs-12"}, 
              React.createElement("h3", null, React.createElement("b", null, this.state.data.title), " (", this.state.data.publishDate, ")")
            ), 
            React.createElement("div", {id: "movieDetailsYear", className: "col-lg-12 col-md-12 col-xs-12"}, 
            ...
            React.createElement("div", {id: "movieDetailsOverview", className: "col-lg-12 col-md-12 col-xs-12"}, 
              React.createElement("h5", null, this.state.data.overview)
            ), 
            React.createElement("div", {id: "movieDetailsCredit", className: "col-lg-6 col-md-6 col-xs-12"}, 
            ...
            React.createElement("div", {id: "movieDetailsCrew", className: "col-lg-6 col-md-6 col-xs-12"}, 
              ...
              React.createElement("div", {id: "movieDetailVideo", className: "col-lg-12 col-md-12 col-xs-12"}, 
      ...
      return (
        React.createElement("div", {id: "movieDetailsContainer", className: "col-lg-12 col-md-12 col-xs-12 movie"}, 
          ...
          React.createElement("div", {id: "movieDetailsContent", className: "col-lg-7 col-md-7 col-xs-12"}, 
            ...
            React.createElement("div", {id: "movieDetailsHomepage", className: "col-lg-12 col-md-12 col-xs-12"}, 
              React.createElement("h5", null, React.createElement("a", {href: this.state.data.homePage}, this.state.data.homePage))
            )
          )
        )
